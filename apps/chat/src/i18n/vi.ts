...
export const vi: Messages = {
  ui: {
    ...
    intakeTitle: 'Một vài thông tin tùy chọn giúp đội ngũ của chúng tôi xử lý nhanh hơn. Bạn có thể bỏ qua bất kỳ mục nào.',
    intakeSkip: 'Bỏ qua',
    intakeContinue: 'Tiếp tục',
    fieldCustomerNumber: 'Số khách hàng',
    fieldSmartpit: 'Số SmartPit',
    fieldRegisteredPhone: 'Số điện thoại đã đăng ký',
    fieldSimIccid: 'Số SIM (ICCID)',
    fieldDeviceModel: 'Kiểu thiết bị',
    fieldTriedAlready: 'Những gì bạn đã thử',
    fieldGmo: 'Số GMO',
