...
export const tl: Messages = {
  ui: {
    ...
    intakeTitle: 'May ilang opsyonal na detalye na makakatulong para mas mabilis itong masolusyunan. Puwede mong laktawan ang alinman dito.',
    intakeSkip: 'Laktawan',
    intakeContinue: 'Magpatuloy',
    fieldCustomerNumber: 'Customer number',
    fieldSmartpit: 'SmartPit number',
    fieldRegisteredPhone: 'Nakarehistrong numero ng telepono',
    fieldSimIccid: 'SIM number (ICCID)',
    fieldDeviceModel: 'Modelo ng device',
    fieldTriedAlready: 'Ano na ang nasubukan mo',
    fieldGmo: 'GMO number',
