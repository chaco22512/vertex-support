...
export const id: Messages = {
  ui: {
    ...
    intakeTitle: 'Beberapa detail opsional membantu tim kami menyelesaikan lebih cepat. Anda boleh melewati semuanya.',
    intakeSkip: 'Lewati',
    intakeContinue: 'Lanjut',
    fieldCustomerNumber: 'Nomor pelanggan',
    fieldSmartpit: 'Nomor SmartPit',
    fieldRegisteredPhone: 'Nomor telepon terdaftar',
    fieldSimIccid: 'Nomor SIM (ICCID)',
    fieldDeviceModel: 'Model perangkat',
    fieldTriedAlready: 'Apa yang sudah Anda coba',
    fieldGmo: 'Nomor GMO',
    sentTitle: 'Terima kasih. Pertanyaan Anda telah dikirim ke tim dukungan kami.',
    sentTitleNamed: 'Terima kasih, {name}. Pertanyaan Anda telah dikirim ke tim dukungan kami.',
    sentWithin24: 'Kami akan membalas dalam 24 jam.',
    sentEmailNote: 'Kami juga akan mengirim balasan ke {contact}.',
    sentWhatsappNote: 'Staf kami mungkin menghubungi Anda di WhatsApp di {contact}.',
    today: 'Hari ini',
    yesterday: 'Kemarin',
    ...
    retry: 'Coba lagi',
    statusAi: 'Asisten AI',
    statusWaitingStaff: 'Tim kami akan membalas dalam 24 jam',
